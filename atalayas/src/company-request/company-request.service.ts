...
export class CompanyRequestService {
  ...
  async create(createCompanyRequestDto: CreateCompanyRequestDto, file: Express.Multer.File) {
    ...
    if(error) throw new InternalServerErrorException('Error al subir el documento');
  ...
  async approve (id: string){
    ...
    if(error) throw new InternalServerErrorException('Error al crear el usuario');
