...
export class ServicesController {
  ...
  async create(@Body() createServiceDto: CreateServiceDto, @Req() requestUser: User) {
     return await this.servicesService.create(createServiceDto, requestUser['user']);
  }
  ...
  @Patch(':id')
  @Roles('ADMIN', 'GENERAL_ADMIN')
  update(@Param('id') id: string, @Body() updateServiceDto: UpdateServiceDto, @Req() requestUser: User) {
    return this.servicesService.update(id, updateServiceDto, requestUser['user']);
  }
